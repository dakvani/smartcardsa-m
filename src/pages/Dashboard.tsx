      ...
      <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-5">
        ...
        <div className="flex flex-col lg:flex-row lg:items-stretch gap-4 mt-4 pb-20 md:pb-0 lg:h-[calc(100vh-7.5rem)]">
          ...
          <details open className="w-full lg:w-[360px] lg:shrink-0 lg:h-full lg:min-h-0 group [&_summary::-webkit-details-marker]:hidden">
            ...
            <div className="bg-background/60 backdrop-blur-sm rounded-xl border border-border/60 p-4 shadow-sm lg:h-full lg:overflow-y-auto scrollbar-hide lg:flex lg:flex-col">
              ...
              {/* iPhone Frame */}
              <div className="mx-auto w-[220px] lg:w-auto lg:flex-1 lg:min-h-0 lg:flex lg:justify-center">
                <div className="relative rounded-[2.75rem] bg-neutral-900 p-[10px] shadow-2xl ring-1 ring-white/10 lg:h-full lg:aspect-[9/19.5] lg:max-w-full">
                  {/* Side buttons */}
